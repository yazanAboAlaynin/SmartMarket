                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header bg-white border-0 pt-5">
                            <h2 class="text-center">{{ __('Vendor Register') }}</h2>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('vendor.create') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="address" type="text" class="middle form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="address" autofocus placeholder="Address">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="phone" type="text" class="middle form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus placeholder="Phone">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="mobile" type="text" class="middle form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') }}" required autocomplete="mobile" autofocus placeholder="Mobile">
